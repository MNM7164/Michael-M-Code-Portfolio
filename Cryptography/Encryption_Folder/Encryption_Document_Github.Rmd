...
we need to establish a system. Crypography uses a a letter to number conversion 
for encryption systems and then a number to letter conversion system for decryption. 
...
coprime numbers between 1 and n multipled by n. Meaning with n=26 we have 
